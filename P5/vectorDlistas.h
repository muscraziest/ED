...
* Asociado al vector disperso, tenemos el valor nulo o valor por defecto de los elementos, el tamaño y una lista con los elementos no nulos, formados por pares (posición, valor).
